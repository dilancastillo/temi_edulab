...
import {
  serializeAssignment,
  serializeAuditLog,
  serializeBuildingFloor,
  serializeCampus,
  serializeClassSession,
  serializeCourse,
  serializeInstitutionBranding,
  serializeInstitutionLicense,
  serializeInstitutionPolicy,
  serializeInstitutionReportSnapshot,
  serializeInstitutionTemplate,
  serializeInstitution,
  serializeLearningSpace,
  serializeMission,
  serializePairingRequest,
  serializeProfile,
  serializeRobot,
  serializeRobotMaintenanceRecord,
  serializeStudent,
...
async function buildInstitutionalSnapshot(app: FastifyInstance, institutionId: string) {
  const [
    campuses,
    floors,
    spaces,
