    ...
    if (body.classSessionId) {
      ...
      await app.prisma.classSession.updateMany({
        ...
        data: {
          status,
          currentStepLabel:
            typeof body.payload === "object" && body.payload !== null && "currentStepLabel" in body.payload
              ? String((body.payload as Record<string, unknown>).currentStepLabel)
              : undefined,
          progressPercent:
            typeof body.payload === "object" && body.payload !== null && "progressPercent" in body.payload
              ? Number((body.payload as Record<string, unknown>).progressPercent)
              : undefined,
