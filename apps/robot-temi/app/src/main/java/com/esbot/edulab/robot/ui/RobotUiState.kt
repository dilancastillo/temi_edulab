    ...
    companion object {
        ...
        fun fromStore(store: RobotStore): RobotUiState {
            ...
            return RobotUiState(
                ...
                nextTurnName = snapshot.nextTurnName,
                ...
                currentActionHint = snapshot.currentActionHint,
                ...
                pairingStatusLabel = snapshot.pairingStatusLabel,
                ...
                studentModeLabel = snapshot.studentModeLabel,
                deviceModeLabel = snapshot.deviceModeLabel,
                executionModeLabel = snapshot.executionModeLabel,
                baseLocationName = snapshot.baseLocationName,
                routePreview = snapshot.routePreviewCsv?.split("|").orEmpty().filter { it.isNotBlank() },
